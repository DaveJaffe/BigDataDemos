...
weblog = LOAD '/user/test/weblogs/access_logs_1TB/*' USING org.apache.pig.piggybank.storage.apachelog.CombinedLogLoader AS (remoteAddr, remoteLogname, user, time, method, uri, proto, status, bytes, referer, userAgent);
...
STORE E into '/user/test/weblogs/w1TB_pig_out2' USING PigStorage;
